...
@Component({
  ...
  template: `
    <div class="page">
      ...
      <div class="body">
        <p class="lede">The native push/pop transition on Angular's own router outlet: the iOS look on iOS and elsewhere, the Android look on Android. Pages stay alive beneath the top: scroll down, open something, swipe back.</p>
        <h2>Demo apps</h2>
